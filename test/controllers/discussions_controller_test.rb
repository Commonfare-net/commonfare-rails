...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { group_id: @discussion.group_id, title: @discussion.title } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { group_id: @discussion.group_id, title: @discussion.title } }
