...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post memberships_url, params: { membership: { commoner_id: @membership.commoner_id, group_id: @membership.group_id, role: @membership.role } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { commoner_id: @membership.commoner_id, group_id: @membership.group_id, role: @membership.role } }
